...
rightColumn = [[sg.Text("Rodzaj drewna: ", k='woodGenreLabel')],
               [sg.Combo(names, expand_x=True, enable_events=True,  readonly=False, key='genre')],
               [sg.Text('Docelowa wilgotność: 8 ÷ 40%')],
